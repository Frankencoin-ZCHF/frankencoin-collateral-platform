...
function ctxFor(source: string): BlockContext {
  ...
  const record = { slug: "wsteth", ticker: "wstETH", name: "Wrapped Staked ETH", address: assessment.data.address, kind: "assessed" as const, lifecycle: "draft" as const, assessment, live: null, addressMismatch: null, issues: [], assessmentUnavailable: null };
